...
chrome.runtime.onInstalled.addListener(function() {
    ...
    featureFlag.licenses && chrome.alarms.create("licenseCheck",{"periodInMinutes": 240});
    chrome.alarms.create("syncAdInfo",{"periodInMinutes": 15});
})
